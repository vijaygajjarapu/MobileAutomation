...
Feature: To complete the registration flow for IEHP user
  ...
  Scenario: Navigate to registration step 1
    ...
    Then User tap "securityQuestion1" button in "Registration" page
    And User fills "answerField1" text field in "Registration" page
    Then User tap "securityQuestion2" button in "Registration" page
    And User fills "answerField2" text field in "Registration" page
    Then User tap "securityQuestion3" button in "Registration" page
    And User fills "answerField3" text field in "Registration" page
    Then User tap "allSet" button in "Registration" page
    Then User tap "allSet" button in "Registration" page
