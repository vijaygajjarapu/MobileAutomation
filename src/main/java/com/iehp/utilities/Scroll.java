...
public class Scroll {
   ...
   // WebElement element = (WebElement) driver.findElements(By.className(“android.widget.NumberPicker”)).get(1);
//element.click();
    public static void scrollKeys(AppiumDriver driver, String[] list) {
        System.out.println("Starting the process");
        for (int i = 0; i < list.length; i++) {
            MobileElement we = (MobileElement) driver.findElement(By.xpath("(//*[@resource-id='android:id/numberpicker_input'])["+(i+1)+"]"));
            we.sendKeys(list[i]);
        }
    ...
    public static void scrollChecker(AppiumDriver driver, String[] list) {
        System.out.println("Starting the process");
        for (int i = 0; i < list.length; i++) {

            MobileElement me = (MobileElement) driver.findElement(By.xpath("(//*[@resource-id='android:id/numberpicker_input'])["+(i+1)+"]"));
    ...
    private static void scrollAndSearch(AppiumDriver driver, String value, MobileElement me, Boolean direction) {
    ...
    // Code here shouldn't be modified
    private static void swipe(AppiumDriver driver, String start, String end, Boolean up) {
        String direction;
        if (up) {
    ...
    // dynamically selecting each scroll wheel
    // Code here shouldn't be modified
    public static void scrollsKeys(AppiumDriver driver, String[] list) {
        System.out.println("Starting the process");
        for (int i = 0; i < list.length; i++) {
            ...
            touchAction6.longPress(element(me)).release();
